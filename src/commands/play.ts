import { StreamType, createAudioResource, VoiceConnectionStatus, AudioPlayerStatus, createAudioPlayer, entersState, getVoiceConnection, joinVoiceChannel } from "@discordjs/voice";
import { GuildMember, SlashCommandBuilder, SlashCommandIntegerOption } from "discord.js";
...
const play: Command = {
    ...
    execute: async (interaction, applicationContext) => {
        ...
        audioPlayer.on(AudioPlayerStatus.Idle, async () => {
            entersState(audioPlayer, AudioPlayerStatus.Playing, 5000)
            .catch(() => {
        ...
        const audioResource = createAudioResource(
            ...
            {
                inputType: song.encoding === "opus" ? StreamType.OggOpus : StreamType.Arbitrary
            }
        )
